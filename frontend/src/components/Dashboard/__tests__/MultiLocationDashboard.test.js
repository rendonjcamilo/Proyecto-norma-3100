...
const mockComplianceData = [
    ...
    },
    {
        ...
        perStandardMetrics: [
            { name: 'Capacidad técnico-administrativa', code: 'CTA', percent: 40, color: 'rojo' },
            { name: 'Políticas y procedimientos', code: 'PP', percent: 45, color: 'rojo' },
            { name: 'Gestión de recursos humanos', code: 'GRH', percent: 50, color: 'naranja' },
        ],
    },
];
describe('MultiLocationDashboard', () => {
    ...
    it('renders loading state initially', () => {
        ...
        render(_jsx(MultiLocationDashboard, {}));
...
//# sourceMappingURL=MultiLocationDashboard.test.js.map