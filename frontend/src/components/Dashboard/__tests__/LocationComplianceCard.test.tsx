/**
 * Location Compliance Card Tests
 */
...
describe('LocationComplianceCard', () => {
  it('renders location name', () => {
    render(<LocationComplianceCard compliance={mockCompliance} />);
  ...
  it('hides hallazgos count when zero', () => {
    ...
    render(<LocationComplianceCard compliance={complianceNoHallazgos} />);
  ...
  it('sorts standards by percentage descending', () => {
    const complianceUnsorted = {
      ...mockCompliance,
      perStandardMetrics: [
        { name: 'A', code: 'A', percent: 50, color: 'naranja' as const },
        { name: 'B', code: 'B', percent: 90, color: 'verde' as const },
        { name: 'C', code: 'C', percent: 70, color: 'naranja' as const },
      ],
    };

    render(<LocationComplianceCard compliance={complianceUnsorted} />);
  ...
  it('applies selected class when isSelected is true', () => {
    const { container } = render(
      <LocationComplianceCard compliance={mockCompliance} isSelected={true} />
    );
  ...
  it('applies semáforo-verde class', () => {
    const { container } = render(<LocationComplianceCard compliance={mockCompliance} />);
  ...
  it('displays naranja semáforo correctly', () => {
    ...
    const { container } = render(<LocationComplianceCard compliance={complianceNaranja} />);
    const card = container.querySelector('.location-compliance-card');
  ...
  it('displays rojo semáforo correctly', () => {
    ...
    const { container } = render(<LocationComplianceCard compliance={complianceRojo} />);
    const card = container.querySelector('.location-compliance-card');
  ...
  it('responds to Enter key press', () => {
    const mockOnClick = jest.fn();
    const { container } = render(
      <LocationComplianceCard compliance={mockCompliance} onClick={mockOnClick} />
    );
  ...
  it('handles single hallazgo singular form', () => {
    ...
    render(<LocationComplianceCard compliance={complianceOneHallazgo} />);
