...
describe('ComplianceCharts', () => {
  it('renders main heading', () => {
    render(<ComplianceCharts data={mockComplianceData} />);
    ...
    const dataWithMoreStandards = [
      {
        ...
        perStandardMetrics: [
          { name: 'Standard A', code: 'SA', percent: 95, color: 'verde' as const },
          { name: 'Standard B', code: 'SB', percent: 90, color: 'verde' as const },
          { name: 'Standard C', code: 'SC', percent: 85, color: 'verde' as const },
          { name: 'Standard D', code: 'SD', percent: 80, color: 'verde' as const },
          { name: 'Standard E', code: 'SE', percent: 75, color: 'naranja' as const },
          { name: 'Standard F', code: 'SF', percent: 70, color: 'naranja' as const },
        ],
      },
      mockComplianceData[1],
    ];

    render(<ComplianceCharts data={dataWithMoreStandards} />);
  ...
  it('applies correct semáforo colors to standards', () => {
    const { container } = render(<ComplianceCharts data={mockComplianceData} />);
  ...
  it('handles single location data', () => {
    ...
    render(<ComplianceCharts data={singleLocation} />);
    expect(screen.getByText('Análisis Comparativo')).toBeInTheDocument();
  ...
  it('handles data with different numbers of standards per location', () => {
    ...
    render(<ComplianceCharts data={mixedData} />);
    expect(screen.getByText(/Promedio por Estándar/)).toBeInTheDocument();
  });
