...
export const WhatsAppPanel: React.FC = () => {
  ...
  const handleEnviarWhatsAppApp = () => {
    ...
    // En Android abre WhatsApp Business directamente por package ID (com.whatsapp.w4b).
    // En iOS/desktop no existe intent:// — se usa wa.me como fallback.
    const isAndroid = /android/i.test(navigator.userAgent);
    const url = isAndroid
      ? `intent://send?phone=${phone}&text=${text}#Intent;scheme=whatsapp;package=com.whatsapp.w4b;end`
