...
describe('FollowUpStep', () => {
  const mockFollowup: ActionFollowup = {
    id: 'fu-1',
    action_id: 'act-1',
    step_number: 1,
  ...
  it('should render followup step', () => {
    render(<FollowUpStep followup={mockFollowup} />);
  ...
  it('should show readonly status badge when readonly', () => {
    render(<FollowUpStep followup={mockFollowup} readonly={true} />);
    expect(screen.getByText('En Progreso')).toBeInTheDocument();
  });

  it('should toggle comment form', () => {
    render(<FollowUpStep followup={mockFollowup} readonly={false} />);
  ...
  it('should calculate days until due', () => {
    ...
    render(<FollowUpStep followup={followupWithFutureDate} />);
  ...
  it('should show overdue indicator', () => {
    ...
    const { container } = render(
      <FollowUpStep followup={overdueFollowup} />
    );
  ...
  it('should display completed status styling', () => {
    ...
    const { container } = render(<FollowUpStep followup={completedFollowup} />);
  ...
  it('should display pending status styling', () => {
    ...
    const { container } = render(<FollowUpStep followup={pendingFollowup} />);
