...
describe('VerificationForm', () => {
    ...
    describe('Component Rendering', () => {
        it('should render form with header', () => {
            render(_jsx(VerificationForm, { actionId: "act-1", actionTitle: "Implementar nuevo sistema", actionDescription: "Implementar nuevo sistema de backup en servidor principal", evidence: mockEvidence, onVerify: mockOnVerify }));
        ...
        it('should display attached evidence', () => {
            render(_jsx(VerificationForm, { actionId: "act-1", actionTitle: "Test Action", actionDescription: "Test Description", evidence: mockEvidence, onVerify: mockOnVerify }));
            expect(screen.getByText('report.pdf')).toBeInTheDocument();
            expect(screen.getByText('screenshot.jpg')).toBeInTheDocument();
        });
        it('should show no evidence message when empty', () => {
            render(_jsx(VerificationForm, { actionId: "act-1", actionTitle: "Test Action", actionDescription: "Test Description", evidence: [], onVerify: mockOnVerify }));
    ...
    describe('Form Cancellation', () => {
        it('should call onCancel when cancel button is clicked', () => {
            render(_jsx(VerificationForm, { actionId: "act-1", actionTitle: "Test Action", actionDescription: "Test Description", evidence: mockEvidence, onVerify: mockOnVerify, onCancel: mockOnCancel }));
    ...
    describe('Accessibility', () => {
        it('should have proper form structure', () => {
            const { container } = render(_jsx(VerificationForm, { actionId: "act-1", actionTitle: "Test Action", actionDescription: "Test Description", evidence: mockEvidence, onVerify: mockOnVerify }));
...
//# sourceMappingURL=VerificationForm.test.js.map