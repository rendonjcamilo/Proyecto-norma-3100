...
vi.mock('../ActionDetail', () => ({
    ActionDetail: () => _jsx("div", { children: "Action Detail" }),
}));
describe('ActionsList', () => {
    ...
    it('should show empty state when no actions', () => {
        ...
        render(_jsx(ActionsList, {}));
        expect(screen.getByText('No hay acciones que coincidan con los filtros')).toBeInTheDocument();
    });
    ...
    it('should display progress bars', () => {
        const { container } = render(_jsx(ActionsList, {}));
...
//# sourceMappingURL=ActionsList.test.js.map